...
<div class="row-project">
    <div class="col-12">
        <div id="projectCarousel" class="project-carousel">
                ...
                <div class="project-slider">
                    <?php foreach ($boxesproject as $box): ?>
                        <div class="col-md-3 mb-4 d-flex">
                           <a href="?project_detail&id=<?= urlencode(base64_encode($box['id'])) ?>&lang=<?= htmlspecialchars($lang) ?>" class="text-decoration-none text-dark w-100">
                                        ...
                                        <div class="project-image-wrapper">
                                            <?php if ($box['image']): ?>
                                                <picture>
                                                    ...
                                                    <img src="<?= htmlspecialchars(str_replace('../','',$box['image'])) ?>" class="project-img-top" alt="<?= htmlspecialchars($box['title']) ?>" loading="lazy">
                                                </picture>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
            ...
            <!-- <button class="scroll-btn left" type="button" onclick="scrollProject('prev')">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button> -->
            <button class="scroll-btn left" onclick="scrollProject('prev')">  <span class="visually-hidden" aria-label="Scroll left">Next</span> ❮</button>
            <!-- <button class="scroll-btn right" type="button" onclick="scrollProject('next')">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button> -->
            <button class="scroll-btn right" onclick="scrollProject('next')">  <span class="visually-hidden" aria-label="Scroll Right">Next</span> ❯</button>
        </div>
    </div>
</div>
<script>
