...
<div style="display: flex; justify-content: space-between;">
    ...
    <div>
        <form method="GET" action="">
            <input type="hidden" name="idia" value="">
    ...
    <?php foreach ($boxesidia as $index => $box): ?>
        <div class="box-news">
            <div class="box-image">
                ...
                <a href="?idia_detail&id=<?php echo $encodedId; ?>&lang=<?php echo $lang; ?>" class="text-news">
...
<div class="pagination">
    <?php if ($page > 1): ?>
        <a href="?idia&page=<?php echo $page - 1; ?>&search=<?php echo urlencode($searchQuery); ?>&lang=<?php echo $lang; ?>">
            <?php echo match ($lang) {
                'en' => 'Previous',
                'cn' => '上一页',
                'jp' => '前へ',
