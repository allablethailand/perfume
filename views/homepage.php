    ...
    <div class="products-container">
        <header class="page-header">
            <h2 class="page-title">
                ...
                echo $product_title[$lang] ?? $product_title['en'];
                ?>
            </h2>
            ...
            if ($products_result && $products_result->num_rows > 0) {
                ...
                <div class="empty-state">
                    <h3>
                        ...
                        echo $empty_title[$lang] ?? $empty_title['en'];
                        ?>
                    </h3>
                    <p>
                        <?php
                        $empty_desc = [
                            'th' => 'ขณะนี้ยังไม่มีสินค้าที่พร้อมขาย',
                            'en' => 'No products available at the moment',
                            'cn' => '目前没有可用的产品',
                            'jp' => '現在利用可能な製品はありません',
                            'kr' => '현재 사용 가능한 제품이 없습니다'
                        ];
                        echo $empty_desc[$lang] ?? $empty_desc['en'];
                        ?>
                    </p>
                </div>
                <?php
        ...
        <div style="text-align: center; margin-top: 60px;">
            <a href="?product&lang=<?= $lang ?>" class="view-all-btn">
                ...
                echo $view_all[$lang] ?? $view_all['en'];
                ?>
            </a>
        </div>
    </div>
