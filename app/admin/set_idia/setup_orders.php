            ...
            <div class="box-content">
                ...
                <h4 class="line-ref mb-3">
                    ...
                    write idia
                        ...
                        <form id="formidia" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div style="margin: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="idia_subject" name="idia_subject">
                                    </div>
                                    <div style="margin: 10px;">
                                        <label for="">
                                        ...
                                        <div>
                                            <textarea class="form-control" id="idia_description" name="idia_description"></textarea>
                                        </div>
                                    </div>
