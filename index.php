...
$allowedRoutes = [
    ...
    'preview', 'orders','ai_activation', 'story', 'soul','ai_questions','ai_edit_prompts', 'ai_chat','ai_chat_3d','order_detail', 'payment', 'cart' ,'checkout','privacy','termofuse' , 'profile', 'lang'
];
