...
$allowedRoutes = [
    ...
    'preview', 'orders','ai_activation','ai_questions','test','ai_edit_prompts', 'ai_chat','ai_chat_3d','order_detail', 'payment', 'cart' ,'checkout','privacy','termofuse' , 'profile', 'lang'
];
...
switch($fragment) {
    ...
    case 'test': require __DIR__.'/views/test.php'; break;
