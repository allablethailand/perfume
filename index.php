...
// Default allowed root path (Production)
$allowedRoot  = '/perfume/';
...
/*
|--------------------------------------------------------------------------
| 3. BYPASS: Admin & Actions (IMPORTANT)
|--------------------------------------------------------------------------
| These paths must not be blocked by frontend router
*/
if (
    strpos($requestPath, $allowedRoot . 'app/admin') === 0 ||
    strpos($requestPath, $allowedRoot . 'app/actions') === 0
) {
    return;
}
...
/*
|--------------------------------------------------------------------------
| 4. SECURITY: Block fake-path spam URLs
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| 5. Extract Query Parameters Safely
|--------------------------------------------------------------------------
*/
$params   = [];
$fragment = '';
...
/*
|--------------------------------------------------------------------------
| 6. SECURE: Whitelist allowed ROUTES
|--------------------------------------------------------------------------
*/
$allowedRoutes = [
    ...
    'preview','orders','ai_activation','ai_questions',
    'ai_chat','order_detail','payment','cart','checkout',
    'privacy','termofuse','profile','lang'
];

if ($fragment !== '' && !in_array($fragment, $allowedRoutes, true)) {
