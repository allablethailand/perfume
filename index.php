...
/*
|--------------------------------------------------------------------------
| 3. Allow ADMIN paths (BYPASS router)
|--------------------------------------------------------------------------
*/
$adminPath = rtrim($allowedRoot, '/') . '/app/admin/';

if (strpos($requestPath, $adminPath) === 0) {
    // Admin pages are handled separately
    return;
}

/*
|--------------------------------------------------------------------------
| 4. SECURITY: Block fake / spam paths (Frontend only)
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| 6. Whitelist allowed ROUTES (Frontend)
|--------------------------------------------------------------------------
*/
$allowedRoutes = [
    ...
    'ai_chat','order_detail', 'payment', 'cart',
    'checkout','privacy','termofuse','profile','lang'
];
...
switch ($fragment) {
    ...
    case 'googleb6dd9f2aa59b820c.html':
        require __DIR__ . '/googleb6dd9f2aa59b820c.html'; break;
