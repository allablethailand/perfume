...
$allowedRoutes = [
    ...
    'preview', 'orders','ai_activation', 'story', 'soul','ai_scan','ai_questions','ai_edit_prompts', 'ai_chat','ai_chat_3d','ai_avatar_demo','order_detail', 'payment', 'cart' ,'checkout','privacy','termofuse' , 'profile', 'lang'
];
...
switch($fragment) {
    ...
    case 'ai_avatar_demo': require __DIR__.'/views/ai_avatar_demo.php'; break;
    case 'ai_edit_prompts': require __DIR__.'/views/ai_edit_prompts.php'; break;
    case 'story': require __DIR__.'/views/story.php'; break;
    case 'soul': require __DIR__.'/views/soul.php'; break;
    case 'ai_scan': require __DIR__.'/views/ai_scan.php'; break;
